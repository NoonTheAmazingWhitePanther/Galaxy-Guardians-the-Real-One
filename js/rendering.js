...
window.Sim.drawSun = t => {
  ...
  ctx.save();
  for (let i = 0; i < 12; i++) {
    const angle = (PI2 / 12) * i + Math.sin(ct * 0.7 + i) * 0.15, flicker = Math.sin(ct * 1.3 + i * 2.1) * 0.5 + 0.5, len = radius * (0.35 + flicker * 0.55);
